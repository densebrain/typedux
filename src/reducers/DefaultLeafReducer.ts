 ...
 * Leaf reducer
 */
export class DefaultLeafReducer<K extends string, S extends State<K>, StateType extends StateConstructor<K, S>, A extends ActionMessage<S>> implements ILeafReducer<S, A> {
   ...
   */
  static makeLeafReducer<K extends string, S extends State<K>, StateType extends StateConstructor<K, S>>(
    leaf:K,
    stateType:StateType
  ...
  constructor(private _leaf:K, private _stateType:StateType) {
  }
